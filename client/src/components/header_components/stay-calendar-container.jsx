...
const StayCalendarContainer = ({ setCheckInSubtext, setCheckOutSubtext,
                                setCheckOutOpen, setCheckinOpen }) => {
  ...
  useEffect(() => {
    if (!checkinDate && !checkoutDate){
        setCheckInSubtext('Add dates');
        setCheckOutSubtext('Add dates');
    }else{
        ...
        setCheckInSubtext(checkinDateString);
        setCheckOutSubtext(checkoutDateString);
    }
...
//   console.log(checkoutDate);
  ...
  return (
    <div className='stay_calendar-container'>
...
export default StayCalendarContainer;