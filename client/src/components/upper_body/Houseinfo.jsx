...
const Houseinfo = ({ positions, rating, numReviews, propertyName,
                    propCity, propCountry, propState, superHost, superHosticon }) => {
                    ...
                    <div className="_dm2bj1">
                        ...
                        { 
                            superHost 
                                ?   <span className="_1jvg42j">
                                        <span className="_12m9c11">
                                            <span className="_8tbpu3" aria-hidden="true" role="img">
                                                <img 
                                                    src={superHosticon} 
                                                    id="hostIcon"
                                                    style={{height: "15px"}}
